...
1. Create a helper function, countOfUnvalidSubstrings, which counts the number of substrings that do not contain all three characters.
   - Initialize a dictionary, mp, to keep track of the counts of characters in the current window.
...
def countOfUnvalidSubstrings(s: str) -> int:
    mp = {}
    start = 0
    ans = 0
