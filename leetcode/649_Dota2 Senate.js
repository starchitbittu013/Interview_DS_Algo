...
var predictPartyVictory = function(senate) {
    ...
    // Enqueue the indices of senators into their respective queues
    ...
    while (radiant.length > 0 && dire.length > 0) {
        ...
        if (radiantIndex < direIndex) {
            // Radiant senator eliminates, enqueue new index after the end
            radiant.push(radiantIndex + senate.length);
            console.log(radiant, dire);
        } else {
            // Dire senator eliminates, enqueue new index after the end
